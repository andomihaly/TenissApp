public class PlayAGame {
    public static void main(String [] args)
    {
        ...
        int numberOfGame=0;
        while (!tennisGame.IsMatchOver(TypeOfTennisMatch.BestOfFive)) {
        ...
        System.out.printf("Game is over %s player is win the tennis match after %d games. %n", tennisGame.GetWinner(2),numberOfGame);
    }
}
